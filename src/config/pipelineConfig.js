...
export const featureFlags = {
  useDirectPipeline: getEnvVar('VITE_USE_DIRECT_PIPELINE', 'true') === 'true',
...
export const buildPipelineInput = (humanPrompt, overrides = {}) => {
  ...
  return {
    ...
    batch_id: batchId,
    additional_prompt:
      overrides.additional_prompt || 'manifested through technodada reality engine',
    options: {
      ...
      response_format:
        overrides.response_format || imageGenerationDefaults.response_format,
    },
