        ...
        return (
          <>
            ...
            <div className="tear-distortion">
              {Array(tearPhase).fill(0).map((_, i) => (
                <div key={i} className="glitch-slice" style={{
      ...
      case 'pixelate':
        return (
          <div className="tear-pixels">
            {Array(tearPhase * 10).fill(0).map((_, i) => (
      ...
      case 'void':
        return (
          <div className="tear-void">
            <div className="void-message" style={{ 
            ...
            {Array(tearPhase).fill(0).map((_, i) => (
              <div key={i} className="void-particle" style={{
      ...
      case 'cascade':
        return (
          <div className="tear-cascade">
            {Array(tearPhase * 3).fill(0).map((_, i) => (
              <div key={i} className="cascade-line" style={{
                left: `${i * 33}%`,
