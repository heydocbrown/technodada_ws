...
const deceptiveRoutes = {
  '/about': { title: 'Gallery', component: Gallery, lie: 'This is definitely the About page' },
  ...
  '/docs': { title: 'DadaCat', component: DadaCat, lie: 'Technical documentation (meow)' }
};
...
function DreamRedirect({ destination }) {
  ...
  return (
    <div className="dream-redirect">
      ...
      <div className="whisper">{destination === '/404' ? 'into the void' : 'following the dream'}</div>
    </div>
  );
}