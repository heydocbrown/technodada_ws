...
function initStatusBar() {
    const realityStatuses = ['UNDEFINED', 'NULL', 'NaN', 'FALSE', '???', 'YES', 'MAYBE', '404'];
...
function initNavigationErrors() {
    ...
    document.querySelectorAll('.error-link').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            setTimeout(() => {
                if (action === 'gallery') window.location.href = '/pages/gallery.html';
                else if (action === 'poems') window.location.href = '/pages/poems.html';
                else if (action === 'tools') window.location.href = '/pages/tools.html';
...
// Console easter eggs
console.log('%c> CONSOLE.LOG IS A SOCIAL CONSTRUCT', 'color: #00ff00; font-family: monospace; font-size: 16px;');
