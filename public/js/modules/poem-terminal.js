...
export class PoemTerminal {
    ...
    loadPoemList() {
        ...
        if (this.poems.length === 0) {
            this.poemListElement.innerHTML = '<div class="poetry-error">POEMS NOT FOUND IN REALITY</div>';
            return;
        }
    ...
    corruptVerses() {
        ...
        this.currentEmotion = Math.min(this.currentEmotion + 1, this.emotionLevels.length - 1);
        this.updateEmotionLevel();
    }
