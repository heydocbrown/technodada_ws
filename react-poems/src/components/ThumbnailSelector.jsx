...
function ThumbnailSelector({ onArtSelect, isVisible = true }) {
    ...
    const fetchArtData = async () => {
        try {
            ...
            const response = await fetch('https://f005.backblazeb2.com/file/td-website/index.json');
            ...
            const websiteEligible = data.images.filter(item => 
                item.on_website === 'yes'
            );
            
            console.log('Website eligible items:', websiteEligible.length);
            console.log('First few items:', websiteEligible.slice(0, 3));
            console.log('Available artprojects:', [...new Set(data.images.map(item => item.artproject))]);
    ...
    const filterData = () => {
        ...
        console.log('Available artprojects:', [...new Set(artData.map(item => item.artproject))]);
        
        const filtered = artData.filter(item => 
            item.artproject === activeProject
        );
            ...
            <div className="art-selector-section">
                <div className="terminal-window">
                    <div className="terminal-header">
                        &gt; LOADING VISUAL_MATRIX...
                    </div>
                    <div className="prompt-terminal" style={{ textAlign: 'center', padding: '40px' }}>
                        <div className="prompt-text">
                            &gt; INITIALIZING GALLERY_BUFFER<br/>
                            &gt; SCANNING REALITY_FRAGMENTS<br/>
                            &gt; PLEASE_WAIT...
    ...
    return (
        <div className="art-selector-section" style={{
            ...
            <div className="terminal-window">
                            ...
                            {currentItems.map((item) => (
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        style={{
                                            display: imageLoadStates[item.run_id] === 'loaded' ? 'block' : 'none'
                                        }}
                                    />
                    ...
                    {totalPages > 1 && (
                        <div className="pagination-controls" style={{
                            ...
                            <button
                                ...
                                style={{
                                    padding: '8px 15px',
                                    background: currentPage === totalPages ? 'var(--gray-2)' : 'var(--gray-1)',
                                    border: '1px solid var(--terminal-green)',
                                    color: currentPage === totalPages ? 'var(--gray-3)' : 'var(--terminal-green)',
                ...
                {filteredData.length > 0 && (
                    <div className="prompt-terminal" style={{ 
                        textAlign: 'center', 
                        padding: '10px 15px', 
                        marginTop: '15px',
                        minHeight: 'auto',
                        ...
                        <div className="prompt-text" style={{ fontSize: '1rem', lineHeight: '1.4' }}>
