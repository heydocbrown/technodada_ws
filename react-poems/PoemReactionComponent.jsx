...
const PoemReactionComponent = ({ poem }) => {
  ...
  useEffect(() => {
    ...
    words.forEach(word => {
      ...
      if (word.includes('transcend') || word.includes('conscious'))
    ...
    switch (dominantEmotion) {
      case 'chaos':
        ...
        setEmotionalResponse(
          'My circuits sing with disorder! Every bit flips with joy!',
        );
        break;
  ...
  return (
    ...
    >
      ...
      <div className="reaction-metrics">
        <span>EMOTIONAL_AMPLITUDE: {Math.random().toFixed(3)}</span>
        <br />
        <span>RESONANCE_FREQUENCY: {(Math.random() * 1000).toFixed(0)}Hz</span>
        <br />
